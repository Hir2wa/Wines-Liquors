<?php
/**
 * Auto Setup Script for PostgreSQL
 * Uses the credentials from your previous successful connection
 */

echo "🐘 PostgreSQL Auto Setup for Total Wine & More\n";
echo "===============================================\n\n";

// Use the credentials from your successful connection
$host = 'localhost';
$port = '5432';
$username = 'postgres';
$password = '2003';
